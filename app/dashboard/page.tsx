  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
      <motion.div
        ...
        className="bg-[#0F0F0F] border border-[#252525] rounded-2xl p-8 max-w-lg w-full relative"
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">You've reached your analysis limit. Upgrade to continue using TradeFlow AI.</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-[#1A1A1A] border border-orange-500/30 rounded-xl p-5 flex flex-col">
            ...
            <a
              href="https://tradeflowai.lemonsqueezy.com/checkout/buy/60423ba8-053a-4d04-a924-69b6aaae30e3"
              target="_blank"
          ...
          <div className="bg-[#1A1A1A] border border-purple-500/30 rounded-xl p-5 flex flex-col relative overflow-hidden">
            ...
            <a
              href="https://tradeflowai.lemonsqueezy.com/checkout/buy/47621ebf-7c5e-4b6e-bbc9-d6bee626b2d4"
              target="_blank"
              rel="noopener noreferrer"
...
export default function AnalyticsDashboard() {
  ...
  const onDrop = useCallback(async (acceptedFiles: File[]) => {
    ...
    // Free plan veya limit dolmuşsa direkt modal göster
  ...
  return (
    <div className="min-h-screen bg-black flex">
      ...
      <div className="flex-1 overflow-auto">
        <header className="border-b border-[#252525] bg-[#0A0A0A] sticky top-0 z-40">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-[#1A1A1A] border border-[#252525] rounded-xl p-6">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 bg-orange-500 rounded-lg text-white font-semibold hover:bg-orange-600 transition flex items-center justify-center gap-2"
                  >
              ...
              {userData?.plan === 'free' && (
                <div className="bg-gradient-to-r from-orange-500/10 to-purple-500/10 border border-orange-500/20 rounded-xl p-4 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-white text-sm">You're on the free plan. Upgrade to unlock full AI analysis.</span>
                  </div>
                  <button
                    onClick={() => setShowUpgradeModal(true)}
                    className="px-4 py-1.5 bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold rounded-lg transition flex-shrink-0"
                  >
                    Upgrade Now
                  </button>
                </div>
