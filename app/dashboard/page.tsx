          ...
          <div className="px-6 py-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-slate-400 mt-1">
                {currentPage === 'dashboard' && 'Upload charts and get AI-powered data analysis'}
              ...
              <div
                ...
                className={`relative overflow-hidden rounded-2xl border-2 border-dashed transition-all cursor-pointer
                  ${isDragActive 
                    ...
                    : 'border-[#252525] bg-[#1A1A1A] hover:border-orange-500/50'
                  }`}
              >
                <input {...getInputProps()} />
                          ...
                          <div className="flex items-center gap-6">
                            ...
                            <div>
                              ...
                              <p className="text-slate-300 text-lg">
                                {parsed.signal === 'UPTREND' ? 'Upward momentum detected' : 
                                 parsed.signal === 'DOWNTREND' ? 'Downward momentum detected' : 
                        ...
                        {parsed.stopLoss && (
                          <div className="bg-[#1A1A1A] border border-red-500/30 rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <h4 className="text-red-400 font-semibold text-sm uppercase">Lower</h4>
                            </div>
                        ...
                        {parsed.takeProfit && (
                          <div className="bg-[#1A1A1A] border border-green-500/30 rounded-xl p-6">
                            <div className="flex items-center gap-2 mb-2">
                              ...
                              <h4 className="text-green-400 font-semibold text-sm uppercase">Upper</h4>
                            </div>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-slate-300 text-sm">
                              This is AI-generated data analysis for educational purposes only. Not financial advice.
                            </p>
                          </div>
                        </div>
                      </div>
