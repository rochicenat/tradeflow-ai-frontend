    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative pt-24 pb-32 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
            <span className="bg-gradient-to-r from-white via-white to-gray-400 bg-clip-text text-transparent">Analyze Any Chart</span>
            <br />
            <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">In Seconds With AI</span>
          </h1>
      ...
      <section className="py-16 px-4 border-y border-gray-800 bg-gray-900/20">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div><div className="text-4xl md:text-5xl font-black text-orange-500 mb-2"><AnimatedCounter end={12400} suffix="+" /></div><div className="text-gray-400 text-sm font-medium">Charts Analyzed</div></div>
          <div><div className="text-4xl md:text-5xl font-black text-orange-500 mb-2"><AnimatedCounter end={3200} suffix="+" /></div><div className="text-gray-400 text-sm font-medium">Active Users</div></div>
          <div><div className="text-4xl md:text-5xl font-black text-orange-500 mb-2"><AnimatedCounter end={3} suffix="s" /></div><div className="text-gray-400 text-sm font-medium">Avg. Analysis Time</div></div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <div className="bg-gradient-to-br from-orange-500/10 to-orange-600/5 border border-orange-500/20 rounded-3xl p-12">
            <h2 className="text-4xl md:text-5xl font-black mb-4">Ready to Trade <span className="text-orange-500">Smarter?</span></h2>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <a href="https://www.producthunt.com/posts/tradeflow-ai" target="_blank" rel="noopener noreferrer" className="inline-block mt-4">
                <img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=tradeflow-ai&theme=dark" alt="TradeFlow AI on Product Hunt" width="200" height="43" />
              </a>
              <div className="flex gap-4">
                ...
                <a href="https://x.com/TradeFlowAii" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-500 transition-colors">
                ...
                <a href="https://www.reddit.com/user/tradeflowai" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-orange-500 transition-colors">
