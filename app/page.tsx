...
const translations = {
  en: {
    ...
    pro_features: ["50 AI chart analyses/month", "Swing & Scalp trading", "Entry, SL & TP levels", "Key levels & pattern recognition", "Risk assessment", "Full analysis history"],
    premium_features: ["Unlimited AI analyses", "Swing & Scalp Premium analysis", "RSI & MA indicator analysis", "Fibonacci levels", "Psychology & Trade Plan", "Breakout & Retest analysis"],
  ...
  tr: {
    ...
    pro_features: ["Aylık 50 yapay zeka analizi", "Swing & Scalp trading", "Giriş, SL & TP seviyeleri", "Kilit seviyeler & formasyon tanıma", "Risk değerlendirmesi", "Tam analiz geçmişi"],
    premium_features: ["Sınırsız yapay zeka analizi", "Swing & Scalp Premium analiz", "RSI & MA indikatör analizi", "Fibonacci seviyeleri", "Psikoloji & Trade Planı", "Kırılım & Retest analizi"],
